...
final class PostController extends AbstractController
{
    ...
    {
        // dd('Continuer la partie', $post);

        // Si le jeton de sécurité est invalide, alors
